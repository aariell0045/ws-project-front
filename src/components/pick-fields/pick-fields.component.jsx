	...
	return (
		<div className="pick-fields-canvas">
			...
			<div className="pick-fields-main-content">
				<div onClick={(event) => handleInputs(event)} id="firstname" className="field-warpper">
					שם פרטי:
					<input type="checkbox" checked={fieldsObject.firstname} id="" />
				</div>
				<div onClick={(event) => handleInputs(event)} id="lastname" className="field-warpper">
					שם משפחה:
					<input type="checkbox" checked={fieldsObject.lastname} id="" />
				</div>
				<div onClick={(event) => handleInputs(event)} id="email" className="field-warpper">
					אמייל:
					<input type="checkbox" checked={fieldsObject.email} id="" />
				</div>
				<div onClick={(event) => handleInputs(event)} id="age" className="field-warpper">
					גיל
					<input type="checkbox" checked={fieldsObject.age} id="" />
				</div>
				<div onClick={(event) => handleInputs(event)} id="birthday" className="field-warpper">
					תאריך לידה:
					<input type="checkbox" checked={fieldsObject.birthday} id="" />
				</div>
				<div onClick={(event) => handleInputs(event)} id="gender" className="field-warpper">
					מגדר:
